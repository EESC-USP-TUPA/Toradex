...
class CANMonitor:
    def __init__(self, interface='can0', max_files=20,
                 internal_dir='/datalogger', usb_dir='/usb_datalogger'):
    ...
    def setup_directory(self, log_dir):
        ...
        # Remove arquivos antigos se excederem o limite
    ...
    def setup_data_logging(self):
        ...
        # Verifica se o diretório USB está disponível
    ...
    def process_can_message(self, message, data):
        ...
        # Processamento baseado no id da mensagem (igual ao código original)...
        if message.arbitration_id == 0x080 and len(message.data) >= 7:
            data.update({
        ...
        while True:
            ...
            try:
                ...
                if msg:
                    ...
                    # Escrita nos dois arquivos, se disponíveis
...
if __name__ == "__main__":
    ...
    try:
        ...
        monitor.logger.info("Encerrando...")
